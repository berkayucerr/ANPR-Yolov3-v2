...
with tf.compat.v1.Session() as sess:
    ...
    boxes, scores, labels = gpu_nms(pred_boxes, pred_scores, 1, max_boxes=10, score_thresh=0.3, nms_thresh=0.45)
    ...
    for belge in tarama:
        ...
        for i in range(len(boxes_)):
            ...
            lptext=pytesseract.image_to_string(crop,lang='eng',config = r'-c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVXWYZ0123456789 --psm 6 --psm 11 ')
